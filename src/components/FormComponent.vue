  ...
  <div>
    ...
    <form @submit.prevent='onSubmit' autocomplete='false' name="form">
      ...
      <b-form-group label='Age'>
        <b-input type='number' v-model='age' v-validate='"between:18,120"' name='age' :value="0"/>
        <p v-if='errors.has("age")'>{{ errors.first('age') }}</p>
      </b-form-group>
      <b-form-group label='Comment'>
        <b-textarea v-model='comment' v-validate='"required"' name='comment'></b-textarea>
...
// var resetForm = <HTMLFormElement>document.getElementById(submit);
// resetForm.reset();
</script>